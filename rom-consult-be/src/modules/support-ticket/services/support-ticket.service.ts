...
export class SupportTicketService {
  ...
  public create(payload: SupportTicketCreateDto): Promise<SupportTicketResponseDto> {
  ...
  public async lookup(
    ...
    if (!ticket) {
      throw new HttpException("supportTicket.error.notFound", HttpStatus.NOT_FOUND);
    }
