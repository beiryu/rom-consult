...
describe("HelperEncryptionService", () => {
  ...
  describe("createAccessToken", () => {
    ...
    it("should handle JWT signing errors", async () => {
      ...
      await expect(service.createAccessToken(mockPayload)).rejects.toThrow(
        "JWT signing failed",
      );
    });
    ...
    it("should work with different payload types", async () => {
      ...
      expect(jwtServiceMock.signAsync).toHaveBeenCalledWith(developerPayload, {
        secret: "accessTokenSecret",
        expiresIn: "1h",
      });
    });
  ...
  describe("createRefreshToken", () => {
    ...
    it("should handle JWT signing errors", async () => {
      ...
      await expect(service.createRefreshToken(mockPayload)).rejects.toThrow(
  ...
  describe("encrypt", () => {
    ...
    it("should encrypt data successfully", async () => {
      ...
      const mockCipher = {
        update: jest.fn().mockReturnValue(Buffer.from("mockEncryptedData")),
