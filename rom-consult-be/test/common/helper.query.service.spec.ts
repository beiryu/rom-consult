  ...
  describe("QueryBuilder", () => {
    ...
    describe("execute", () => {
      ...
      it("should skip search if query is empty", async () => {
        ...
        await service.query(mockDelegate).search("", ["name"]).execute();
      ...
      it("should throw and log error on execute failure", async () => {
        ...
        await expect(service.query(mockDelegate).execute()).rejects.toThrow(
          mockError,
        );
    ...
    describe("getMany", () => {
      ...
      it("should handle sorting in getMany", async () => {
        ...
        await service.query(mockDelegate).sort({ name: "asc" }).getMany();
      ...
      it("should handle include in getMany", async () => {
        ...
        await service.query(mockDelegate).include({ posts: true }).getMany();
      ...
      it("should throw and log error on getMany failure", async () => {
        ...
        await expect(service.query(mockDelegate).getMany()).rejects.toThrow(
          mockError,
        );
    ...
    describe("getFirst", () => {
      ...
      it("should handle include in getFirst", async () => {
        ...
        await service.query(mockDelegate).include({ profile: true }).getFirst();
      ...
      it("should handle select in getFirst", async () => {
        ...
        await service.query(mockDelegate).select({ id: true }).getFirst();
      ...
      it("should throw and log error on getFirst failure", async () => {
        ...
        await expect(service.query(mockDelegate).getFirst()).rejects.toThrow(
          mockError,
        );
    ...
    describe("count", () => {
      ...
      it("should throw and log error on count failure", async () => {
        ...
        await expect(service.query(mockDelegate).count()).rejects.toThrow(
          mockError,
        );
