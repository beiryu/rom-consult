...
export interface AlertFloatingProps {
    ...
    onConfirm?: () => void;
    /**
     * Optional link used for the confirm action.
     */
    confirmHref?: string;
}

export const AlertFloating = ({ title, description, confirmLabel, onClose, onConfirm, confirmHref, color = "default", dismissLabel = "Dismiss" }: AlertFloatingProps) => {
    return (
                ...
                {(onConfirm || onClose || confirmHref) && (
                    <div className="flex gap-3">
                        ...
                        {onConfirm ? (
                            ...
                            confirmHref && (
                                <Button href={confirmHref} size="sm" color="link-color">
                                    {confirmLabel}
                                </Button>
                            )
                        )}
