...
export const DropdownAccountCardMD = () => {
    const [selectedAccount, setSelectedAccount] = useState<Selection>(new Set(["rum-consult"]));
        ...
        <Dropdown.Root>
            ...
            >
                <AvatarLabelGroup
                    ...
                    status="online"
                    title="Olivia Rhye"
                    subtitle="olivia@rumconsult.com"
                />
            ...
            <Dropdown.Popover className="w-60">
                ...
                <Dropdown.Menu>
                    ...
                    <Dropdown.Section selectionMode="single" selectedKeys={selectedAccount} onSelectionChange={setSelectedAccount}>
                        ...
                        <Dropdown.Item id="rum-consult">Rum Consult</Dropdown.Item>
                ...
                <div className="flex justify-between border-t border-secondary px-4 py-3">
                    <span className="truncate text-sm text-quaternary">&copy; Rum Consult</span>
