...
export const DropdownSearchAdvanced = () => {
    const [selectedUsers, setSelectedUsers] = useState<Selection>(new Set(["rum-consult", "shutterframe"]));
            ...
            <Dropdown.Popover className="w-60">
                <Autocomplete filter={contains}>
                    ...
                    <Dropdown.Menu selectionMode="multiple" selectedKeys={selectedUsers} onSelectionChange={setSelectedUsers}>
                        <SubmenuTrigger>
                            <Dropdown.Item id="rum-consult" textValue="Olivia Rhye" selectionIndicator="checkbox">
                                Rum Consult
                            </Dropdown.Item>
